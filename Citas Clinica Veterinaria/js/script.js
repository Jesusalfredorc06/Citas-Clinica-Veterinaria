...
class citas {
    ...
    constructor() {
        this.citas = [];//en la clase constructor generar un arreglo de citas vacio
    }
    ...
    imprimirCitas({ citas }) {
        ...
        citas.forEach(citas => {
            ...
            propietarioParrafo.innerHTML = `
                <span class="font-weigh-bolder">Propietario:</span>${propietario}`;
            ...
            sintomasParrafo.innerHTML = `
                <span class="font-weigh-bolder">Sintomas:</span>${sintomas}`;
...
function nuevaCita(e) {
    ...
    if (editar) {
        ...
        //mensaje datos correctos
        useri.imprimirAlerta('Se ha agregado la cita correctamenta');
    }
    //crear nuevas citas
    //reset al formulario
    formulario.reset();
